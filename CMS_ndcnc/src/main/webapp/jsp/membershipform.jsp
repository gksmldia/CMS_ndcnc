			...
			<form name="membershipForm" class="formBottom15"
				...
				<div class="row">
					<div class="col-md-push-3 col-md-3">
						<input type="text" name="firstName" class="form-control "
							placeholder="이름" alt="이름 입력 폼" />
					</div>
					<div class="col-md-3 col-md-push-3">
						<input type="text" name="lastName" class="form-control "
							placeholder="성" alt="성 입력 폼" />
					</div>
				</div>
				<div class="row">
					<div id="has-error" class="col-md-push-3 col-md-3">
						<input id="password" type="password" name="password"
							class="form-control " placeholder=" 비밀번호" alt="비밀번호 입력 폼" />
						<div>
							<small class="text-muted">숫자, 영문자 조합으로 8~15자리를 사용하세요.</small>
						</div>
					</div>

					<div id="has-error-check" class="col-md-push-3 col-md-3">
						<input id="password_check" type="password" name="passwordcheck"
							class="form-control" placeholder="비밀번호 확인" alt="비밀번호 확인 입력 폼" />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<input type="date" name="birth" class="form-control "
							alt="생년월일 선택 폼">
						<div>
							<small class="text-muted">생년월일을 선택해 주세요.</small>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<select name="question" class="form-control ">
							<option value="계정 or 비밀번호 찾기용 선택하세요" disabled selected>
								계정 or 비밀번호 찾기용 질문</option>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 ">
						<input type="text" name="answer" placeholder="답변"
							class="form-control " alt="아이디 or 비밀번호 찾기용 답변 입력 폼" />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center ">
						<button type="submit"
							class="btn btn-primary marginRight marginBottom100">회원
							가입</button>
					...
					$('#email_eq').text('');
							...
							$('#password_check').keyup(
									function() {
										...
										var checkword = $('#password_check')
												.val();

										if (checkword != password.substr(0,
												checkword.length)) {
											addDontMiss();
										} else {
											removeDontMiss();
							...
							function addDontMiss() {
								...
								$('#password_eq').text('비밀번호가 일치하지 않습니다.')
							...
							function addHasError() {
								...
								$('#regPasssword')
										.text(
												'특수문자 ,문자,숫자 포함 형태의 8~15자리 이내의 암호를 작성해주세요.')
										.addClass('text-danger');
							}
