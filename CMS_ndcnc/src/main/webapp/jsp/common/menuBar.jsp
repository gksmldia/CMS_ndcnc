	...
	<div class="row">
		...
		<c:choose>
			<c:when test="${ memberVO eq null }">
				<div class="col-md-3 text-right" style="margin-top: 3; padding-right: 0px; width: 135;">
					<a href="${ pageContext.request.contextPath }/index.jsp" class="topA">로그인</a>
				</div>
				<div class="col-md-1" style="width: 30;">
					<div class="division"></div>
				</div>
				<div class="col-md-3 text-left" style="margin-top: 3; padding-left: 0px; width: 135;">
